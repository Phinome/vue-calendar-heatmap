...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<g" + _vm._ssrAttr("transform", _vm.monthsLabelWrapperTransform[_vm.position]) + " class=\"vch__months__labels__wrapper\" data-v-4d3c7add>" + _vm._ssrList(_vm.heatmap.firstFullWeekOfMonths, function (month, index) {
    return "<text" + _vm._ssrAttr("x", _vm.getMonthLabelPostion(month).x) + _vm._ssrAttr("y", _vm.getMonthLabelPostion(month).y) + " class=\"vch__month__label\" data-v-4d3c7add>" + _vm._ssrEscape("\n      " + _vm._s(_vm.lo.months[month.value]) + "\n    ") + "</text>";
  }) + "</g> <g" + _vm._ssrAttr("transform", _vm.daysLabelWrapperTransform[_vm.position]) + " class=\"vch__days__labels__wrapper\" data-v-4d3c7add><text" + _vm._ssrAttr("x", _vm.vertical ? _vm.SQUARE_SIZE * 1 : 0) + _vm._ssrAttr("y", _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 18) + " class=\"vch__day__label\" data-v-4d3c7add>" + _vm._ssrEscape("\n      " + _vm._s(_vm.lo.days[_vm.getDateIndex(1)]) + "\n    ") + "</text> <text" + _vm._ssrAttr("x", _vm.vertical ? _vm.SQUARE_SIZE * 3 : 0) + _vm._ssrAttr("y", _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 42) + " class=\"vch__day__label\" data-v-4d3c7add>" + _vm._ssrEscape("\n      " + _vm._s(_vm.lo.days[_vm.getDateIndex(3)]) + "\n    ") + "</text> <text" + _vm._ssrAttr("x", _vm.vertical ? _vm.SQUARE_SIZE * 5 : 0) + _vm._ssrAttr("y", _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 67) + " class=\"vch__day__label\" data-v-4d3c7add>" + _vm._ssrEscape("\n      " + _vm._s(_vm.lo.days[_vm.getDateIndex(5)]) + "\n    ") + "</text></g> "), _vm._ssrNode("<g" + _vm._ssrAttr("transform", _vm.yearWrapperTransform) + _vm._ssrClass(null, ['vch__year__wrapper', this.clickedIndex !== -1 ? 'vch__days__selected' : '']) + " data-v-4d3c7add>", "</g>", _vm._l(_vm.heatmap.calendar, function (week, weekIndex) {
    return _vm._ssrNode("<g" + _vm._ssrAttr("transform", _vm.getWeekPosition(weekIndex)) + " class=\"vch__month__wrapper\" data-v-4d3c7add>", "</g>", _vm._l(_vm.getFilterWeek(week), function (day, dayIndex) {
      return _c('rect', {
        directives: [{
          name: "tooltip",
          rawName: "v-tooltip",
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-4d3c7add_0", {
    source: "div.vch__container[data-v-4d3c7add]{position:relative}svg.vch__wrapper[data-v-4d3c7add]{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,Ubuntu,Cantarell,'Open Sans','Helvetica Neue',sans-serif;line-height:10px}svg.vch__wrapper .vch__months__labels__wrapper text.vch__month__label[data-v-4d3c7add]{font-size:6px}svg.vch__wrapper .vch__days__labels__wrapper text.vch__day__label[data-v-4d3c7add]{font-size:6px}svg.vch__wrapper .vch__days__labels__wrapper text.vch__day__label[data-v-4d3c7add],svg.vch__wrapper .vch__months__labels__wrapper text.vch__month__label[data-v-4d3c7add]{fill:#767676}svg.vch__wrapper rect.vch__day__square[data-v-4d3c7add]:focus{outline:0}svg.vch__wrapper g.vch__days__selected rect[data-v-4d3c7add]{opacity:.5}svg.vch__wrapper g.vch__year__wrapper rect.vch__day__square__actived[data-v-4d3c7add]{opacity:1}",
    map: undefined,
    media: undefined
  }), inject("data-v-4d3c7add_1", {
...
var __vue_scope_id__ = "data-v-4d3c7add";
/* module identifier */

var __vue_module_identifier__ = "data-v-4d3c7add";
/* functional template */
